...
- [OUT-401 BacktestReportPresenter](out_401_backtest_report_presenter.md) — issue #23: PASS, 88/88, 776 assertions; per-date BacktestError correctly excluded from report rows, not faked.
