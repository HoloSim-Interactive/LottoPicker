...
- [DATA-IN-101 missing real CSV](data_in_101_missing_real_csv.md) — closed issue #27: real CSV confirmed era boundary as 1999-10-24 (was 1999-01-01); reuse the deferred-check pattern for any future client-artifact-gated test clause.
